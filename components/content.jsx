      ...
      <div style={{ marginTop: 80 }}>
        ...
        <div style={{
          ...
          {[
            ...
            { name: 'MEMBER, 5', img: 'assets/member-05-before-after.jpg' },
            { name: 'MEMBER, 6', img: 'assets/member-06-before-after.jpg' },
            { name: 'MEMBER, 7', img: 'assets/member-07-before-after.jpg' },
            { name: 'MEMBER, 8', img: 'assets/member-08-before-after.jpg' },
          ].map((item, i) => (
            <div key={i}>
              {item.img ? (
                <div style={{
